        ...
        <div style="height: 33rem;">
            <div class="card-deck" style="margin: 6rem 10rem 2rem 31rem; width: 30rem; height: 26rem;">
                <div class="card shadow-lg" style="border-radius: 15px; border: none;">
                    <div class="card-body">
                        <h5 class="card-title" style="margin-top: 1rem; text-align: center; font-family: 'Bangers'; font-size: 60px;">INICIAR SESIÓN</h5>
                        <div class="row" style="margin-left: 3rem;">
                            <form style="padding: 0;" method="post" action="usuariosLoginConexion.php">
                                <table style="border-collapse: separate; border-spacing: 10px 15px;">
                                    <tr>
                                        <td>E-MAIL: </td>
                                        <td><input type="email" name="Correo_electronico" style="border: 0; border-radius: 10px; background: #c7c7c7;" required></td>
                                     </tr>
                                     <tr>
                                        <td>CONTRASEÑA: </td>
                                        <td><input type="password" name="Contrasena" style="border: 0; border-radius: 10px; background: #c7c7c7;" required></td>
                                     </tr>
                                </table>
                        ...
                        <div style="margin-top: 3.5rem; text-align: center;">
                            ...
                            <div style="margin-top: 1rem;">
                                <button class="btn my-2 my-sm-0 shadow-lg" type="submit" style="width: 11rem; height: 2.5rem; background: #ffffff; border-radius: 20px; font-weight: bold; color: #525252; font-size: 15px; text-decoration: none;">
                                   INICIAR SESIÓN
                                </button>
                            </div>
                            <div style="margin-top: 1.5rem;">
                                <button class="btn my-2 my-sm-0 shadow-lg" type="submit" style="width: 8rem; height: 2.5rem; background: #EA920F; border-radius: 20px;">
                                    <a href="./registro.html" style="font-weight: bold; color: #ffffff; font-size: 12px; text-decoration: none;">REGISTRATE</a>
                                </button>
                            </div>
                        </form>
                        </div>
