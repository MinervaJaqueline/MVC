...
$con = conecta();
    $consulta ="select Nom_producto, Precio from rproducto where categoria='comida' ;";
                    ...
                    <div>
                        <div class="card-deck" style="margin: 1rem;">
                            <div class="card shadow-lg" style="border-radius: 15px; border: none; height: 22rem;">
                               ...
                               echo "<img class='card-img' src='./src/img/C".$id.".jpg' style='border-radius: 15px; height: 150px; width:260px;'>";
