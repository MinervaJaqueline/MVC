            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav mr-auto" style="padding: 0 2rem;">
                    ...
                    <li class="nav-item active" style="padding: 0 4rem;">
                        <a class="nav-link" href="./bebida.php">BEBIDAS <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item" style="padding: 0 4rem;">
...
$con = conecta();
    $consulta ="select Nom_producto, Precio from rproducto where categoria='bebidas' ;";
                    ...
                    <div>
                        <div class="card-deck" style="margin: 1rem;">
                            <div class="card shadow-lg" style="border-radius: 15px; border: none; height: 22rem;">
                               ...
                               echo "<img class='card-img' src='./src/img/B".$id.".jpg' style='border-radius: 15px; height: 150px; width:260px;'>";
